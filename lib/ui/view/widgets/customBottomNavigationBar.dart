...
class Custombottomnavigationbar  extends StatelessWidget{
  ...
  Widget build(BuildContext context){
    ...
    child: BottomNavigationBar(
      ...
      onTap: (index){
        if (index==indiceCorrente) return; //se gli indici sono uguali allora ritorno
        ...
        switch(index){
          ...
          case 1:
          Navigator.pushReplacement(context, MaterialPageRoute(builder: (_)=> BenvenutoPage()));
          break;
          ...
          case 4:
          Navigator.pushReplacement(context, MaterialPageRoute(builder: (_)=> PremiScreen()));
          break;

        }
      },
      type: BottomNavigationBarType.fixed,  //li rendo fissi così da poterli modificare
      selectedItemColor: Colors.black,    //quelli dell'indice li coloro di nero
      ...
      selectedLabelStyle: TextStyle(fontWeight: FontWeight.bold),  //metto il grassetto a quelli dell'indice
      selectedIconTheme: IconThemeData(size: 30),    //ingrandisco le icone selezionate
      backgroundColor: Colors.white,  //colore bianco     
      items: [
        BottomNavigationBarItem( icon: Icon(Icons.home_outlined), label: "Home" ),
        BottomNavigationBarItem(icon: Icon(Icons.bar_chart_outlined), label: "Statistiche" ),
        BottomNavigationBarItem(icon: Icon(Icons.place_outlined), label: "Mappa" ),
        BottomNavigationBarItem(icon: Icon(Icons.qr_code), label: "Scan" ),
        BottomNavigationBarItem(icon: Icon(Icons.emoji_events_outlined), label: "Premi" ),
      ],
    )
      )
    );
